        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MembershipPlans_Entitlement", "(\"EntitlementType\" = 'SessionPack' AND \"SessionCount\" IS NOT NULL AND \"SessionCount\" > 0) OR (\"EntitlementType\" = 'TimePeriod' AND \"DurationDays\" IS NOT NULL AND \"DurationDays\" > 0)");
                    table.ForeignKey(
                        name: "FK_MembershipPlans_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionsRemaining = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipPlans_ServiceId",
                table: "MembershipPlans",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_MembershipPlans_TenantId_Name",
                table: "MembershipPlans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Memberships_TenantId_MemberId_Status",
                table: "Memberships",
